...
import com.SneakStyle.OrderService.configuration.interceptor.RestTemplateInterceptor;
...
public class Config {
    ...
    public Config(ClientRegistrationRepository clientRegistrationRepository, OAuth2AuthorizedClientRepository oAuth2AuthorizedClientRepository) {
